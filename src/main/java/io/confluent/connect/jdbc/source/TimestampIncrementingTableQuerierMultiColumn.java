 ...
 * </p>
 */
public class TimestampIncrementingTableQuerierMultiColumn extends TableQuerier implements CriteriaValues<Timestamp,IncrementingOffset> {
  private static final Logger log = LoggerFactory.getLogger(
      TimestampIncrementingTableQuerierMultiColumn.class
  );

  protected final List<String> timestampColumnNames;
  protected TimestampIncrementingOffsetBase<Timestamp,IncrementingOffset> committedOffset;
  protected TimestampIncrementingOffsetBase<Timestamp,IncrementingOffset> offset;
  protected TimestampIncrementingCriteriaMultiColumn criteria;
  ...
  private List<String> incrementingColumnNames;
  private final long timestampDelay;
  private final TimeZone timeZone;

  public TimestampIncrementingTableQuerierMultiColumn(DatabaseDialect dialect, QueryMode mode, String name,
                                           String topicPrefix,
                                           List<String> timestampColumnNames,
                                           List<String> incrementingColumnNames,
                                           Map<String, Object> offsetMap, Long timestampDelay,
                                           TimeZone timeZone, String suffix,
                                           TimestampGranularity timestampGranularity) {
    super(dialect, mode, name, topicPrefix, suffix);
    this.incrementingColumnNames = incrementingColumnNames;
    this.timestampColumnNames = timestampColumnNames != null
        ? timestampColumnNames : Collections.emptyList();
    this.timestampDelay = timestampDelay;
    this.committedOffset = this.offset = TimestampIncrementingOffsetMultiColumn.fromMap(offsetMap);
  ...
  protected void createPreparedStatement(Connection db) throws SQLException {
    ...
    List<ColumnId> incrementingColumns = new ArrayList<ColumnId>();
    if (incrementingColumnNames != null && !incrementingColumnNames.isEmpty()) {
      for (String incrementingColumnName : incrementingColumnNames) {
        incrementingColumns.add( new ColumnId(tableId, incrementingColumnName));
      }
    }
  ...
  public String toString() {
    return "TimestampIncrementingTableQuerier{"
           ...
           + ", incrementingColumns='" + (incrementingColumnNames != null
